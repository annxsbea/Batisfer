    ...
    <div>
      ...
      <div className="container mx-auto py-8 mt-48 overflow-auto"> 
        <div className="text-center mb-20">
          <h1 className="text-3xl font-bold mb-4 text-black">Laminados</h1>
          <p className="text-lg text-gray-700">Explore nossa linha de laminados e suas características.</p>
        </div>
