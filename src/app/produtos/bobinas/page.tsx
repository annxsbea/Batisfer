...
const produtosBobinas = [
  {
    ...
    descricao: "Bobina de alta qualidade, ideal para diversas aplicações.",
    imagem: "/imagens/bobina1.jpg",
  },
  {
    id: 2,
    nome: "Bobina de Aço 2",
    descricao: "Bobina versátil, disponível em várias espessuras.",
      ...
      <main className="flex-grow">
        <div className="container mx-auto py-12 mt-32 max-w-screen-lg">
          <div className="text-center mb-16">
            <h1 className="text-4xl font-bold mb-4 text-[#6B0808]">Bobinas</h1>
            <p className="text-lg text-gray-700">
              Nossas bobinas são de alta qualidade e atendem a diversas necessidades.
            </p>
          </div>
